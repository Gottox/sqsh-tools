...
int16_t
squash_format_directory_entry_inode_offset(const struct SquashDirectoryEntry *entry) {
...
uint16_t
squash_format_directory_entry_name_size(const struct SquashDirectoryEntry *entry) {
...
uint32_t
squash_format_directory_fragment_count(const struct SquashDirectoryFragment *fragment) {
	return le32toh(fragment->count);
}
uint32_t
squash_format_directory_fragment_start(const struct SquashDirectoryFragment *fragment) {
...
squash_format_directory_fragment_entries(const struct SquashDirectoryFragment *fragment) {
