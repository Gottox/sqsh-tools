...
#define ENSURE_FORMAT_ORDER_16(x)
#define ENSURE_FORMAT_ORDER_32(x)
#define ENSURE_FORMAT_ORDER_64(x)
#define ENSURE_HOST_ORDER_16(x)
#define ENSURE_HOST_ORDER_32(x)
#define ENSURE_HOST_ORDER_64(x)
#else
